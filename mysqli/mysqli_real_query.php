...
try {
    ...
    $db->real_query($sql);
    // unbuffered query return result set if needed with calling store_result() or get_result()
    // default return is boolean indicate that query run successfully or not
